...
class Alignment2TestCase < Test::Unit::TestCase
  def test_church_alignment
    ...
    x = [ Alignment2::AlignableText.new("foo"), Alignment::AlignableText.new("koo") ]
    y = [ Alignment2::AlignableText.new("bar"), Alignment::AlignableText.new("baz") ]
  ...
  def test_church_text_alignment
    assert_equal [["The quick brown fox", "Den kvikke brune reven"], ["jumps", "hopper"], ["over the lazy dog", "over den trege hunden"]],
      Alignment2::align_text("The quick brown fox | jumps | over the lazy dog",
